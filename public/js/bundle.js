...
var _UsersList = __webpack_require__(38);
  ...
  _createClass(MainContainer, [{
    ...
    value: function getUsers() {
      ...
      _axios.default.get('/users').then(function (res) {
        ...
        console.log(_this2.state.user['user_name']);
      }).catch(function (err) {
        console.log(err);
      });
    }
    ...
    value: function handleUserEdit(e) {
      this.setState({
        user: _defineProperty({}, e.target.name, e.target.value)
      });
    }
  }, {
    key: "handleClick",
    ...
    value: function handleChange(e) {
      this.setState(_defineProperty({}, e.target.name, this.tryParse(e.target.value)));
    }
  }, {
    key: "tryParse",
...
var _Editables = __webpack_require__(37);
...
function (_React$Component) {
  ...
  function UserProfile(props) {
    ...
    _this.makeEditable = _this.makeEditable.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(UserProfile, [{
    ...
    value: function render() {
      return _react.default.createElement("div", {
        ...
        textType: "text",
        pClass: "user-age",
        value: this.props.user.user_age + " years old"
      }), _react.default.createElement("div", {
