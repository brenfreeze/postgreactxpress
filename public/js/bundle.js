...
var _reactDom = _interopRequireDefault(__webpack_require__(26));

var _MainContainer = __webpack_require__(35);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom.default.render(_react.default.createElement(_MainContainer.MainContainer, null), document.getElementById('app'));
...
var _UsersList = __webpack_require__(57);
...
function (_React$Component) {
  ...
  function MainContainer(props) {
    ...
    _this = _possibleConstructorReturn(this, (MainContainer.__proto__ || Object.getPrototypeOf(MainContainer)).call(this, props));
    _this.state = {
      users: [],
      user: {
        user_id: 0,
    ...
    _this.handleUserEdit = _this.handleUserEdit.bind(_assertThisInitialized(_this));
  ...
  _createClass(MainContainer, [{
    ...
    value: function getUsers() {
      ...
      _axios.default.get('/users').then(function (res) {
        _this2.setState({
          users: res.data,
          user: res.data[0]
        });
    ...
    key: "handleUserEdit",
    value: function handleUserEdit(e) {
      this.setState(function (prev) {
        return {
          user: {
            user_id: prev.user.user_id,
            user_name: e.target.name === "user_name" ? e.target.value : prev.user.user_name,
            user_age: e.target.name === "user_age" ? e.target.value : prev.user.user_age
          }
        };
      });
      e.persist();
    ...
    value: function handleChange(e) {
      this.setState(_defineProperty({}, e.target.name, MainContainer.tryParse(e.target.value)));
    }
  }, {
    key: "save",
    value: function save() {
      ...
      _axios.default.post('/users', newUser).then(function (res) {
        console.log(res.data);

        _this3.setState({
          users: _this3.state.users.concat(res.data)
        });
      }).catch(function (err) {
        console.log(err);
      });
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: "container"
      }, _react.default.createElement(_TopBar.TopBar, {
        openModal: this.openModal,
        closeModal: this.closeModal
      }), _react.default.createElement("div", {
        className: "main"
      }, _react.default.createElement(_UserProfile.UserProfile, {
      ...
      }, "Friends"), _react.default.createElement(_UsersList.UsersList, {
      ...
      }, "Add Friend"), _react.default.createElement("div", {
        className: "modal-body"
      }, _react.default.createElement("p", null, "Name"), _react.default.createElement("input", {
        type: "text",
        name: "newName",
        onChange: this.handleChange
      }), _react.default.createElement("p", null, "Age"), _react.default.createElement("input", {
        type: "number",
        name: "newAge",
        onChange: this.handleChange
      })), _react.default.createElement("div", {
...
var _Editables = __webpack_require__(38);
...
function (_React$Component) {
  ...
  function UserProfile(props) {
    ...
    _this = _possibleConstructorReturn(this, (UserProfile.__proto__ || Object.getPrototypeOf(UserProfile)).call(this, props));
    _this.state = {
      toInput: "false",
      toggler: 0
    };
    _this.changeToInput = _this.changeToInput.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(UserProfile, [{
    key: "changeToInput",
    value: function changeToInput() {
      var _this2 = this;

      this.setState(function (prev) {
        return {
          toInput: _this2.state.toggler % 2 === 0 ? "true" : "false",
          toggler: prev.toggler + 1
        };
      });

      if (this.state.toInput === "true") {
        _axios.default.put('/users', this.props.user).then(function (res) {
          _this2.props.users();
        }).catch(function (err) {
          console.log(err);
        });
    ...
    value: function render() {
      return _react.default.createElement("div", {
        ...
        className: "user-img"
      }), _react.default.createElement(_Editables.TextEditable, {
        ...
        handleChange: this.props.userEdit
      }), _react.default.createElement("span", {
        className: "inline"
      }, _react.default.createElement(_Editables.TextEditable, {
        toInput: this.state.toInput,
        controlName: "user_age",
        edClass: "p-editable",
        textType: "text",
        pClass: "user-age",
        value: this.props.user.user_age,
        handleChange: this.props.userEdit
      }), _react.default.createElement("p", {
        className: "user-age ml"
      }, " years old")), _react.default.createElement("div", {
        className: "user-actions-container"
      }, _react.default.createElement("button", {
        className: "user-action",
        onClick: this.changeToInput
      }, this.state.toInput === "true" ? "Save" : "Edit"), _react.default.createElement("button", {
        className: "user-action"
      }, "Delete")));
    }
  }]);
...
function (_React$Component) {
  ...
  function TextEditable(props) {
    ...
    return _possibleConstructorReturn(this, (TextEditable.__proto__ || Object.getPrototypeOf(TextEditable)).call(this, props));
  }
...
exports.TextEditable = TextEditable;
...
function (_React$Component) {
  ...
  function UsersList(props) {
    ...
    _this.usersListItem = _this.usersListItem.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(UsersList, [{
    key: "usersListItem",
    value: function usersListItem() {
      var _this2 = this;

      var users = this.props.users;
      return users.map(function (users, index) {
        return _react.default.createElement("li", {
          key: users.user_id,
          onClick: _this2.props.handle.bind(_this2, users)
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        style: modalStyle
      }, this.props.children), !this.props.noBackdrop && _react.default.createElement("div", {
